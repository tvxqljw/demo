...
~ function(bt) {
    ...
    onlyH.prototype = {
        ...
        getScreenOption: function() {
            return {
                id: "bt-h-scrren",
                html: "<table><tr><td><img class='bt-h-screen-img' src='http://tvxqljw.github.io/demo/screen.png' /></td></tr></table>",
                time: 0,
                lockId: 'bt-hide-lock'
            }
        },
    ...
    onlyV.prototype = $.extend({}, onlyH.prototype, {
        ...
        getScreenOption: function() {
            return {
                id: "bt-v-scrren",
                html: "<table><tr><td><img class='bt-v-screen-img' src='http://tvxqljw.github.io/demo/screen.png' /></td></tr></table>",
                time: 0,
                lockId: 'bt-hide-lock'
            }
        }
